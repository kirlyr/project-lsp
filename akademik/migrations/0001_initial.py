# Generated by Django 5.2.15 on 2026-06-04 15:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guru', models.ForeignKey(db_column='guru_id', on_delete=django.db.models.deletion.CASCADE, to='akademik.guru')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guru', models.ForeignKey(db_column='guru_id', on_delete=django.db.models.deletion.CASCADE, to='akademik.guru')),
                ('mata_pelajaran', models.ForeignKey(db_column='mata_pelajaran_id', on_delete=django.db.models.deletion.CASCADE, to='akademik.matapelajaran')),
                ('siswa', models.ForeignKey(db_column='siswa_id', on_delete=django.db.models.deletion.CASCADE, to='akademik.siswa')),
            ],
            options={
                'db_table': 'nilai',
            },
